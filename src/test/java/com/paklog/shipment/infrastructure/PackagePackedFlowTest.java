...
class PackagePackedFlowTest {
    ...
    void setUp() {
        ...
        shipmentEventProperties.getDispatched().setTopic("shipment-dispatched");
        shipmentEventProperties.getDelivered().setType("com.paklog.shipment.delivered.v1");
        shipmentEventProperties.getDelivered().setTopic("shipment-delivered");
    ...
    void endToEndPackagePackedCreatesShipmentAndOutboxEvent() {
        Package packageDetails = new Package(2.0, 10.0, 5.0, 5.0, "BOX");
        ...
        when(carrierAdapter.createShipment(packageDetails)).thenReturn("trk-flow");

        PackagePackedEventConsumer consumer = new PackagePackedEventConsumer(shipmentApplicationService, metricsService);
        ...
        assertThat(outboxEvent.getDestination()).isEqualTo("shipment-dispatched");
